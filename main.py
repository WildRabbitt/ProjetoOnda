...
try:
        for row in range(1,19):
                ...
                sleep(1.5)
                navegador.find_element(By.XPATH,'/html/body/form[2]/div[3]/div[1]/dl[6]/dd/button[3]').click()  # Abrir cadastro cliente
                sleep(1.5)
               ...
               # navegador.find_element(By.XPATH,'/html/body/div[12]/div/div[6]/table/tbody/tr/td[1]/div').click()  #Selecionar o plano (Primeira linha(/html/body/div[14]/div/div[6]/table/tbody/tr/td[2]/div)
                ...
                ssid = ssid[0]
                navegador.find_element(By.XPATH,'/html/body/form[5]/div[3]/div[1]/dl[18]/dd/input').send_keys(str.upper(ssid)) #Preencher nome do wifi
                sleep(0.5)
                navegador.find_element(By.XPATH,'/html/body/form[5]/div[3]/div[1]/dl[20]/dd/input').send_keys(str.upper(ssid)+"_5G") #preencher nome do wifi
                sleep(0.5)
                print("Salvar")
